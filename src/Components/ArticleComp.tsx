...
const ArticleComp = ({ type, dop,logo, img="",  location, buttonText, buttonColor, userImg, username, views, workDesc,heading, companyName }: Article) => {
    return (
        <div className="d-flex flex-column border border-1 rounded-2" style={{ maxWidth: '692px', borderColor: 'rgb(224, 224, 224)', fill: 'rgb(255, 255, 255)' }}>
            {img && <img src={img} alt="Nature" className="imagePost"  height='220px'/>}
            <div className="p-4">
                <h3 className="d-flex">{logo + type}</h3>
