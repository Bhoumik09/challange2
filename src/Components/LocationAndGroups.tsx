...
import activism from '../assets/activisism.jpg'
  ...
  return (
    <div className="container d-none d-lg-flex flex-column mt-4">
      ...
      <div className="d-flex flex-column gap-4">
        {/* Each group section */}
        <GroupBar img={leisure} grpName="Leisure"/>
        <GroupBar img={activism} grpName="Activism"/>
        <GroupBar img={mba} grpName="MBA"/>
        <GroupBar img={phil} grpName="Philosophy"/>
      </div>
...
export default LocationAndGroups;
